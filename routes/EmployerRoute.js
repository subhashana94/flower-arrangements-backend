...
import {deleteEmployee, registerEmployee, searchEmployee, updateEmployee} from "../controller/EmployerController.js";
...
router.delete("/delete/:id", authenticateToken, isAdmin, deleteEmployee);
